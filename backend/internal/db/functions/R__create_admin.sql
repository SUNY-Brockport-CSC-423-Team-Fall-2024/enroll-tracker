...
BEGIN
    ...
    RETURNING username, Administrator.id, Administrator.first_name, Administrator.last_name, Administrator.auth_id, Administrator.phone_number, Administrator.email, Administrator.office, Administrator.created_at, Administrator.updated_at; 
END;
$$
LANGUAGE plpgsql;
