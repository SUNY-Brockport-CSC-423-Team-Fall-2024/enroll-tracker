        ...
        <div>
            <form onSubmit={changePassword} className={styles.change_password_form}>
                <div className={styles.change_password_form_field}>
                    ...
                    <input type="password" id="current_password" name="current password"onChange={(e) => handleTextInputChange(setCurrentPassword,e)} minLength={8} maxLength={30} />
                </div>
                <div className={styles.change_password_form_field}>
                    <label htmlFor="new_password">New Password</label>
                    <input type="password" id="new_password" name="new password" onChange={(e) => handleTextInputChange(setNewPassword,e)} minLength={8} maxLength={30}/>
                </div>
                <div className={styles.change_password_form_field}>
                    <label htmlFor="confirm_password">Confirm Password</label>
                    <input type="password" id="confirm_password" name="confirm password" onChange={(e) => handleTextInputChange(setConfirmPassword,e)} minLength={8} maxLength={30} />
                </div>
                <div className={styles.change_password_result_field}>
                    { resultMessage && 
                        <p className={clsx({[styles.change_password_success_message] : resetSuccess}, {[styles.change_password_error_message]: !resetSuccess})}>
                            {resultMessage}
                        </p>
                    }
                </div>
